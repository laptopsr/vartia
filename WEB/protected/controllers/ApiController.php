...
public function actionTiedosto()
{

	  	if (!file_exists(Yii::app()->basePath."/../img/kuvat")) {
		  	mkdir(Yii::app()->basePath."/../img/kuvat", 0777, true);
		}

		$kuva = time().".jpg";
    	 	if (move_uploaded_file($_FILES['file']['tmp_name'], Yii::app()->basePath."/../img/kuvat/".$kuva)) 
		{
